...
const Footer = () => {
  ...
  return (
    <footer
      className="py-16 border-t border-gray-300 text-gray-700"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          >
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                <h3 className="text-2xl font-bold text-gray-800">Gajanand Enterprise</h3>
                <p className="text-xs text-gray-600 font-medium">Quality is Priority</p>
              </div>
            </div>
            ...
            <ul className="space-y-3">
              {links.map((link) => (
                <li key={link.path}>
                  <Link
                    to={link.path}
                    className="text-base text-gray-700 hover:text-gold transition-all duration-300 inline-block hover:translate-x-2"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          >
            <h4 className="text-xl font-semibold mb-6 text-gray-800">Contact</h4>
