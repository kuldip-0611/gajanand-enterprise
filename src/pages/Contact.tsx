      ...
      <div className="container mx-auto px-6 lg:px-8 py-16 md:py-24">
        <div className="max-w-7xl mx-auto">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {info.href ? (
                          <a
                            ...
                            className={`text-sm sm:text-base md:text-lg break-words overflow-wrap-anywhere transition-colors ${
                              info.label === 'Email' || info.label === 'Phone'
                                ? 'font-semibold text-gold hover:text-gold/80'
          ...
          <motion.section
            ...
            className="mt-16"
          >
            <h2 className="text-2xl md:text-3xl font-bold text-navy dark:text-white mb-4">Find us</h2>
            <div className="rounded-2xl overflow-hidden border border-gray-200 dark:border-gray-700 shadow-lg aspect-video min-h-[320px] bg-gray-100 dark:bg-gray-800">
              <iframe
                title="Gajanand Enterprise location"
                src="https://www.google.com/maps?q=23.0382,72.5912&z=17&output=embed"
                width="100%"
                height="100%"
            ...
            <a
              href="https://maps.app.goo.gl/zgCFQhm2cZchjZAK8"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block mt-3 text-gold font-semibold hover:underline"
            >
              Open in Google Maps
            </a>
          </motion.section>
